      ...
      <nav className="container mx-auto flex items-center justify-between py-5 px-6">
        ...
        <div>
          <Link
            draggable="false"
            to="/"
            className="flex items-center gap-1 text-2xl font-bold text-gray-900 hover:text-gray-700 transition-colors select-none"
          >
            <PiRabbitFill className="w-6 h-6 mb-0.5 text-rabbit-red" />
            <span>Rabbit</span>
          </Link>
        </div>
